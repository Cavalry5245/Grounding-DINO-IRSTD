...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", '-i', default='data/NUDT-SIRST/annotations/test.json', type=str, help="input list name")
    parser.add_argument("--output", '-o', default='data/NUDT-SIRST/annotations/test.jsonl', type=str, help="output list name")
